...
export function TimelineItem({ event }: TimelineItemProps) {
  return (
    <div className="flex items-stretch gap-5">
      <div className="flex w-[1.1875rem] shrink-0 flex-col items-center gap-1.5 self-stretch">
        <span className="flex items-center justify-center rounded-full border-[0.5px] border-primary-800 bg-primary-800 p-[0.3125rem]">
          <span className="size-[0.3125rem] rounded-full bg-surface-light-2" />
        </span>
