...
export function ImpactCta({ title, description, image, button }: ImpactCtaProps) {
  return (
    <section className="flex w-full items-stretch bg-primary-900 p-20">
      <div className="relative flex w-full items-stretch overflow-hidden rounded-2xl shadow-[4px_4px_200px_0px_rgba(229,241,255,0.3)]">
        ...
        <div className="relative flex w-full items-center justify-end bg-gradient-to-l from-[rgba(0,45,102,0.9)] via-[rgba(0,45,102,0.5)] to-transparent px-20 py-20">
          <div className="flex max-w-[500px] flex-col items-stretch gap-6">
            <div className="flex flex-col items-start gap-4">
              <h2 className="font-heading text-h2 font-bold text-surface-light">
                {title}
              </h2>
