...
export function Decouvrir() {
  return (
    <section className="flex w-full flex-col items-center bg-surface p-6 sm:p-10 lg:p-20">
      <Container className="flex flex-col items-center gap-8 md:flex-row md:gap-16 lg:gap-24">
        <div className="relative isolate w-full max-w-[23.75rem] shrink-0 md:w-[26.25rem] lg:w-[33.1875rem]">
        ...
        <div className="flex w-full flex-1 flex-col items-start gap-2">
          ...
          <Button
            href="/a-propos"
            variant="outline"
            className="px-12 py-4 text-paragraph-lg"
          >
            En savoir plus
          </Button>
        </div>
