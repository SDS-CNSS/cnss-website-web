...
export function Hero() {
  return (
    <section className="relative flex min-h-[520px] w-full items-center justify-center overflow-hidden md:min-h-[700px]">
      <Image
      ...
      <div className="relative flex max-w-[1280px] flex-col items-center justify-center px-6 py-16 text-center sm:px-10 md:py-32">
        <div className="flex max-w-[768px] flex-col items-center gap-6 md:gap-8">
          ...
          <p className="max-w-[700px] text-base font-semibold text-white opacity-90 sm:text-paragraph-lg">
