...
export function PageBanner({ title, breadcrumbs }: PageBannerProps) {
  return (
    <section className="relative flex w-full flex-col items-start justify-center overflow-hidden bg-surface-light-2 px-4 py-8 sm:px-6 md:h-[13.75rem] md:px-10 md:py-0 lg:px-20">
      <Container className="relative flex flex-col items-start gap-6 md:h-full md:flex-row md:items-center md:justify-between md:gap-10">
